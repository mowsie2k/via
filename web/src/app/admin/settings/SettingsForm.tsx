      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like VIA to retain chat messages. Leaving this field empty will cause VIA to never delete chat messages."
